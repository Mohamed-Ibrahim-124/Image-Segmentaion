...
if __name__ == '__main__':
    ...
    for i in[3,5,7,9,11]:
        ...
        image2 = draw_clusters(assigns, i, image_shape)
        # imshow(image2)
        print(i)
        plt.imshow(image2)
        plt.show()
